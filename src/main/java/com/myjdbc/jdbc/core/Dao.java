...
public interface Dao {
     ...
     */
    <T> List<T> find(Connection con, String sql, Class<T> cls, Object... values) throws SQLException;//查询
     ...
     * @date 2019/7/11 10:00
     */
    List<Object[]> findObjects(Connection con, String sql, Object... values) throws SQLException;//查询
     ...
     * @date 2019/7/11 10:00
     */
    List<Map<String, Object>> findMap(Connection con, String sql, Object... values) throws SQLException;//查询
     ...
     */
    int findCount(Connection con, String sql, Object... values) throws SQLException;
}
