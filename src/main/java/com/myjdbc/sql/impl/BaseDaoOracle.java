 ...
 */
public class BaseDaoOracle<T> extends DaoImpl implements BaseDao<T> {
    ...
    protected BaseDaoOracle(Class<T> mainCls, String mainKey) {
        this.mainCls = mainCls;
        this.mainKey = mainKey;
    }

    protected BaseDaoOracle(Class<T> mainCls, String mainKey, PoolConnection conn) {
        this.mainCls = mainCls;
        this.mainKey = mainKey;
        this.conn = conn;
    }
