...
import com.myjdbc.jdbc.util.DBToPojo;
...
public class DaoImpl implements Dao {
    ...
    private DBToPojo dtop = new DBToPojo();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= size; i++) {
                    ...
                    if (o != null) {
                        if (o.getClass() == Clob.class || o.getClass() == CLOB.class) {
                            //大数据类型进行适配
                            o = TypeCconvert.ClobToString((Clob) o);
                        }
                        map.put(rs.getMetaData().getColumnLabel(i), o);
                    }
                }
                list.add(map);
            }
