...
//    public Map<String, Object> findMapById(Class<? extends Object> cls, Serializable id) ;
    ...
    <T> List<T> criteriaEq(Class<T> cls, String fieldName, Object filedValue, boolean parentFlag);
     ...
     * @return
     */
    List findAll(CriteriaQuery criteriaQuery, String sql, Object... values);
     ...
     * @return
     */
    List<Object[]> findAll(String sql, Object... values);
     ...
     */
    <T> List<T> findAll(Class<T> cls, String sql, Object... values);
