 ...
 * @date 2019/7/15 9:47
 */
public class CriteriaQueryJdbc<T> extends CriteriaQueryBase<T> implements CriteriaQuery {
    private static final Logger logger = LoggerFactory.getLogger(CriteriaQueryJdbc.class);


    public CriteriaQueryJdbc(Class<T> cls) {
        super(cls);
    }

    public CriteriaQueryJdbc(Class<T> cls, T t) {
        super(cls);
        try {
