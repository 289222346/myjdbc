...
public class DbConfig {
    ...
    static {
        ...
        //获取用户名
        Object username = util.readProperty(PropertiesJDBC.USERNAME.getCode());
        USERNAME = username != null ? username + "" : null;

        //获取用户密码
        Object password = util.readProperty(PropertiesJDBC.PASSWORD.getCode());
        PASSWORD = password != null ? password + "" : null;

        //数据库
        Object database = util.readProperty(PropertiesJDBC.DATABASE.getCode());
        DATABASE = database != null ? database + "" : null;

        //公钥
        Object publicKey = util.readProperty(PropertiesJDBC.PUBLIC_KEY.getCode());
